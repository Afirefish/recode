...
//    NSArray *arr1 = [cMgr getContactList:1 contactType:0];
//    for (NSInteger i = 0; i < [arr1 count]; i ++) {
//        CContact *user = [arr1 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr1 name %@",userName);
//    }
//    NSArray *arr2 = [cMgr getContactList:2 contactType:0];
//    for (NSInteger i = 0; i < [arr2 count]; i ++) {
//        CContact *user = [arr2 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr2 name %@",userName);
//    }
//    NSArray *arr3 = [cMgr getContactList:3 contactType:0];
//    for (NSInteger i = 0; i < [arr3 count]; i ++) {
//        CContact *user = [arr3 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr3 name %@",userName);
//    }
//    NSArray *arr4 = [cMgr getContactList:4 contactType:0];
//    for (NSInteger i = 0; i < [arr4 count]; i ++) {
//        CContact *user = [arr3 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr4 name %@",userName);
//    }
//    NSArray *arr5 = [cMgr getContactList:5 contactType:0];
//    for (NSInteger i = 0; i < [arr5 count]; i ++) {
//        CContact *user = [arr5 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr5 name %@",userName);
//    }
//    NSArray *arr6 = [cMgr getContactList:6 contactType:0];
//    for (NSInteger i = 0; i < [arr6 count]; i ++) {
//        CContact *user = [arr6 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr6 name %@",userName);
//    }
//    NSArray *arr7 = [cMgr getContactList:7 contactType:0];
//    for (NSInteger i = 0; i < [arr7 count]; i ++) {
//        CContact *user = [arr7 objectAtIndex:i];
//        NSString *userName = [user valueForKey:@"m_nsUsrName"];
//        NSLog(@"arr7 name %@",userName);
//    }
}
